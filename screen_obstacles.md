...
But you can change this to the today more convenient keybinding/kemapping Ctrl-c (german keyborad Strg-c): really Ctrl-c in a shell? yes indeed this sounds weird, but works and doesn't stop kill a process as you are in the "screen" command mode which you activated by pressing F12 in your byobu session! 
